...
import Image from '../../../assets/tutor-hom-page-image.jpg'; // Header background image
import Footer from '../../../common-components/Footer'; // Footer component
import Laptop from '../../../assets/laptop_image.png'; // Laptop image for card
import Monitor from '../../../assets/monitor_image.png'; // Monitor image for section
import SocialReach from '../../../assets/social_reach.png'; // Social reach image for section
  ...
  return (
    <div className="min-h-screen flex flex-col items-center">
      ...
      <div className="w-full flex items-center justify-center bg-gradient-to-b from-blue-200 to-gray-200">
        <div className="w-full flex flex-col px-48 py-14 gap-8">
